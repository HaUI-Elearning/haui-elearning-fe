      ...
      <div>
        ...
        {courses.length > 0 ? (
            ...
            {courses.map((courseItem) => (
              ...
              >
                <div
                  ...
                  onClick={() => handleCourseClick(courseItem.courseId)}
                >
                  <Grid container>
                    <Grid item md={3}>
                      <Card sx={styles.card}>
                  ...
                  <hr
                    style={{ margin: "16px 0", border: "0.5px solid #ccc" }}
                  />
                </div>
              </Tooltip>
            ))}
          ...
          <Box sx={styles.boxNoCourse}>
            <Typography variant="h5" sx={styles.typoNoCourse1}>
              Không có khóa học
            </Typography>
            <Typography
              variant="body1"
            ...
            >
              Vui lòng kiểm tra lại lựa chọn của bạn hoặc thử tìm một khóa học
              khác.
            </Typography>
          </Box>
        )}
